...
import org.zealot.javatuples.valueintf.IValueLabel;
import org.zealot.javatuples.valueintf.IValueValue;
...
public final class LabelValue<A,B> 
	...
	public <X> LabelValue<X,B> setLabel(final X label) {
        return new LabelValue<X,B>(label, (B) super.getValue(1));
    }
    
    
    @SuppressWarnings("unchecked")
	public <Y> LabelValue<A,Y> setValue(final Y value) {
        return new LabelValue<A,Y>((A) super.getValue(0), value);
    }
